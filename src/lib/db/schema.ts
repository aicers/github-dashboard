...
const SCHEMA_STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS sync_config (
    ...
    transfer_sync_hour_local INTEGER NOT NULL DEFAULT 4,
    transfer_sync_minute_local INTEGER NOT NULL DEFAULT 0,
    transfer_sync_timezone TEXT NOT NULL DEFAULT 'UTC',
    transfer_sync_last_started_at TIMESTAMPTZ,
    transfer_sync_last_completed_at TIMESTAMPTZ,
    transfer_sync_last_status TEXT NOT NULL DEFAULT 'idle',
    transfer_sync_last_error TEXT,
  ...
  `ALTER TABLE sync_config ADD COLUMN IF NOT EXISTS transfer_sync_hour_local INTEGER NOT NULL DEFAULT 4`,
  `ALTER TABLE sync_config ADD COLUMN IF NOT EXISTS transfer_sync_minute_local INTEGER NOT NULL DEFAULT 0`,
  `ALTER TABLE sync_config ADD COLUMN IF NOT EXISTS transfer_sync_timezone TEXT NOT NULL DEFAULT 'UTC'`,
  `ALTER TABLE sync_config ADD COLUMN IF NOT EXISTS transfer_sync_last_started_at TIMESTAMPTZ`,
  `ALTER TABLE sync_config ADD COLUMN IF NOT EXISTS transfer_sync_last_completed_at TIMESTAMPTZ`,
  `ALTER TABLE sync_config ADD COLUMN IF NOT EXISTS transfer_sync_last_status TEXT NOT NULL DEFAULT 'idle'`,
  `ALTER TABLE sync_config ADD COLUMN IF NOT EXISTS transfer_sync_last_error TEXT`,
